"""
Django settings for progettoDjango project.
...
SECRET_KEY = 'django-insecure-no0(773*0c*e6%8ozjg!m0dn9@hg6sr=hr#o96x=_39&(7p_je'
...
ROOT_URLCONF = 'progettoDjango.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates', os.path.join(BASE_DIR, 'EventManager', 'Templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'progettoDjango.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db_versione2.sqlite3',
    }
}
...
# AUTH_USER_MODEL = "EventManager.Utente"
